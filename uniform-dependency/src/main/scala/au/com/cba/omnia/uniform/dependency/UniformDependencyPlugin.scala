...
object UniformDependencyPlugin extends Plugin {
  ...
  object hadoopCP {
    val modules = List[ModuleID](
      ...
      "org.apache.hadoop"            % "hadoop-yarn-api"           % "2.5.0-cdh5.2.0",
      "org.apache.hadoop"            % "hadoop-yarn-client"        % "2.5.0-cdh5.2.0",
      "org.apache.hadoop"            % "hadoop-yarn-common"        % "2.5.0-cdh5.2.0",
      "org.apache.hadoop"            % "hadoop-yarn-server-common" % "2.5.0-cdh5.2.0",
